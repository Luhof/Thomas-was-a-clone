...
void playerPlayerCollisions(Player * player, Players *playersList, int keyJump){
		...
		while(tempPlayer2!=NULL){
			...
			**	horizontal collision
			**/
				if(placeMeeting(coordTopY+player->vspeed, coordRightX+player->hspeed,coordBottomY+player->vspeed, coordLeftX+player->hspeed, coordTopY2, coordRightX2, coordBottomY2, coordLeftX2))
				{
